...
class MYDS(Dataset):
    def __init__(self, embedding_list_train: list, label_path: str, mapping_path: str, data_dir: str, batch_size: int = 30):
        self.chunked_list = np.array_split(
            embedding_list_train, indices_or_sections=40)

    def __len__(self):
        return len(self.x_paths) + 1
